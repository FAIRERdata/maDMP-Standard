...
The <b>GC-RDA maDMP Application Profile</b> serves as the input for Go code in folder [rda_dmp_common_standard_doc_generator](https://github.com/FAIRERdata/maDMP-Standard/tree/Master/rda_dmp_common_standard_doc_generator) which creates the README.md output which is further deployed in the GitHUb page. 
